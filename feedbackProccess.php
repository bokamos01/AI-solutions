...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Combine feedback type and rating with feedback text
    $completeFeeback = "Type: $feedbackType\n\nRating: " . ($rating > 0 ? $rating . " stars" : "Not rated") . "\n\nFeedback:\n$feedback";
    ...
    try {
        // Submit the feedback
        $result = $da->SubmitFeedback($firstName, $lastName, $email, $phone, $completeFeeback);
